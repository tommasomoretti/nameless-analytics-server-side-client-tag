...
|:---|:---|:---|:---|
| Data validation | `🔴 Tag execution failed` | The request was blocked by the Client Tag logic. | Check the server logs for specific validation errors (IP, Origin, etc.). |
